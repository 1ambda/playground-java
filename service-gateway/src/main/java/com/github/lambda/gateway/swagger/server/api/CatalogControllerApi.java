...
public interface CatalogControllerApi {
    ...
    @RequestMapping(value = "/catalog/products",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<PaginatedProductDTO> findPaginatedProducts(@Min(0)@ApiParam(value = "") @Valid @RequestParam(value = "page", required = false) Long page,@Min(8)@ApiParam(value = "") @Valid @RequestParam(value = "size", required = false) Long size,@ApiParam(value = "") @Valid @RequestParam(value = "sort", required = false) List<String> sort,@Min(1)@ApiParam(value = "") @Valid @RequestParam(value = "categoryId", required = false) Long categoryId,@ApiParam(value = "") @Valid @RequestParam(value = "search", required = false) String search,@Min(0)@ApiParam(value = "") @Valid @RequestParam(value = "minPrice", required = false) Long minPrice,@Min(0)@ApiParam(value = "") @Valid @RequestParam(value = "maxPrice", required = false) Long maxPrice,@Min(0)@ApiParam(value = "") @Valid @RequestParam(value = "minRate", required = false) Long minRate,@ApiParam(value = "") @Valid @RequestParam(value = "tags", required = false) List<String> tags,@ApiParam(value = "") @Valid @RequestParam(value = "minShippingDate", required = false) String minShippingDate) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
