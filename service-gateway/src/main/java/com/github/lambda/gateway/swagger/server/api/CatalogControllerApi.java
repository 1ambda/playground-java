...
public interface CatalogControllerApi {
  ...
  default ResponseEntity<CategoryListDTO> findAllCategories() {
    if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
      if (getAcceptHeader().get().contains("application/json")) {
        try {
          return new ResponseEntity<>(getObjectMapper().get().readValue(
              "{  \"items\" : [ {    \"path\" : \"path\",    \"displayName\" : \"displayName\",    \"name\" : \"name\",    \"description\" : \"description\",    \"parentCategoryId\" : 6,    \"id\" : 0  }, {    \"path\" : \"path\",    \"displayName\" : \"displayName\",    \"name\" : \"name\",    \"description\" : \"description\",    \"parentCategoryId\" : 6,    \"id\" : 0  } ]}",
              CategoryListDTO.class), HttpStatus.NOT_IMPLEMENTED);
        } catch (IOException e) {
      ...
      log.warn(
          "ObjectMapper or HttpServletRequest not configured in default CatalogControllerApi interface so no example is generated");
    }
  ...
  @ApiOperation(value = "",
      nickname = "findOneProduct",
      notes = "",
      response = ProductContainerDTO.class,
      tags = {"catalog-controller",})
  @ApiResponses(value = {
  ...
  @RequestMapping(value = "/catalog/product/{productId}",
      produces = {"application/json"},
      method = RequestMethod.GET)
  default ResponseEntity<ProductContainerDTO> findOneProduct(@ApiParam(value = "",
      required = true) @PathVariable("productId") Long productId) {
    if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
      if (getAcceptHeader().get().contains("application/json")) {
        try {
          return new ResponseEntity<>(getObjectMapper().get().readValue(
              "{  \"item\" : {    \"imageId\" : 2,    \"categoryPath\" : \"categoryPath\",    \"imagePath\" : \"imagePath\",    \"categoryDisplayName\" : \"categoryDisplayName\",    \"description\" : \"description\",    \"createdAt\" : 6,    \"price\" : 5,    \"name\" : \"name\",    \"onSale\" : \"onSale\",    \"id\" : 0,    \"imageType\" : \"imageType\",    \"categoryId\" : 5,    \"updatedAt\" : 1  },  \"options\" : [ {    \"price\" : 9,    \"name\" : \"name\",    \"description\" : \"description\",    \"onSale\" : \"onSale\",    \"id\" : 7  }, {    \"price\" : 9,    \"name\" : \"name\",    \"description\" : \"description\",    \"onSale\" : \"onSale\",    \"id\" : 7  } ]}",
              ProductContainerDTO.class), HttpStatus.NOT_IMPLEMENTED);
        } catch (IOException e) {
          log.error("Couldn't serialize response for content type application/json", e);
          return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
  ...
  @ApiOperation(value = "",
      nickname = "findPaginatedProducts",
      notes = "",
      response = PaginatedProductDTO.class,
      tags = {"catalog-controller",})
  @ApiResponses(value = {
  ...
  @RequestMapping(value = "/catalog/products",
      produces = {"application/json"},
      method = RequestMethod.GET)
  default ResponseEntity<PaginatedProductDTO> findPaginatedProducts(
      @Min(0) @ApiParam(value = "") @Valid @RequestParam(value = "page", required = false) Long page,
      @Min(8) @ApiParam(value = "") @Valid @RequestParam( value = "size", required = false) Long size,
      @ApiParam(value = "") @Valid @RequestParam( value = "sort", required = false) List<String> sort,
      @Min(1) @ApiParam(value = "") @Valid @RequestParam( value = "categoryId", required = false) Long categoryId,
      @ApiParam(value = "") @Valid @RequestParam( value = "search", required = false) String search,
      @Min(0) @ApiParam(value = "") @Valid @RequestParam( value = "minPrice", required = false) Long minPrice,
      @Min(0) @ApiParam(value = "") @Valid @RequestParam( value = "maxPrice", required = false) Long maxPrice,
      @Min(0) @ApiParam(value = "") @Valid @RequestParam( value = "minRate", required = false) Long minRate,
