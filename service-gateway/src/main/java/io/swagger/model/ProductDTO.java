...
import io.swagger.model.ProductItemDTO;
import io.swagger.model.ProductOptionDTO;
...
public class ProductDTO   {
  ...
  @Valid
  @Builder.Default
  private List<ProductOptionDTO> options = new ArrayList<ProductOptionDTO>();
  ...
  **/
  ...
  public ProductDTO addOptionsItem(ProductOptionDTO optionsItem) {
    if (this.options == null) {
      this.options = new ArrayList<ProductOptionDTO>();
    }
