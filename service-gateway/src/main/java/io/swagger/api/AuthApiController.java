...
public class AuthApiController implements AuthApi {
    ...
    public ResponseEntity<UserDTO> login() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<UserDTO>(objectMapper.readValue("{  \"password\" : \"password\",  \"address\" : \"address\",  \"provider\" : \"provider\",  \"roles\" : [ \"roles\", \"roles\" ],  \"name\" : \"name\",  \"email\" : \"email\",  \"username\" : \"username\"}", UserDTO.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<UserDTO> register(@ApiParam(value = ""  )  @Valid @RequestBody UserDTO body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<UserDTO>(objectMapper.readValue("{  \"password\" : \"password\",  \"address\" : \"address\",  \"provider\" : \"provider\",  \"roles\" : [ \"roles\", \"roles\" ],  \"name\" : \"name\",  \"email\" : \"email\",  \"username\" : \"username\"}", UserDTO.class), HttpStatus.NOT_IMPLEMENTED);
